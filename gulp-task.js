...
module.exports = function (config) {
    var html = [
        ...
        tmpHtml = '',
        length = '/web/static/html/'.length,
        collector = listdir('./web/static/html');
    ...
    function listdir(dir) {
        ...
        files.forEach(function (file) {
            ...
            var url = absolutePath.substring(absolutePath.indexOf('./web/static/html/') + length + 1);
    ...
    var out = fs.createWriteStream('./web/static/index.html', {encoding: "utf8"});
